        ...
        return this.each(function () {
            ...
            if (options.dataDefault.length > 0) {
                ...
                for (var index in options.dataDefault) {
                    ...
                    items += '<div class="item" data-id="' + item.id + '" data-text="' + item.title + '" style="background-color: white; opacity: 1; z-index: 100;"> <i class="'+options.iconItem+'"></i> ' + item.title + ' </div>';
                }
